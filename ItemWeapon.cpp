...
void ItemWeapon::draw(){
    ...
    if(this->hoveringOver){
        ...
        al_draw_textf(smallFont, rarityColor, mouseX, mouseY-165, 0, "Accuracy: %.2f deg spread", 25.5-this->weaponStats[weaponAccuracy]*25.5);
        al_draw_textf(smallFont, rarityColor, mouseX, mouseY-150, 0, "Crit Chance: %.2f%%", this->weaponStats[weaponCritChance]*100);
        al_draw_textf(smallFont, rarityColor, mouseX, mouseY-135, 0, "Crit Strength: %.2f%%", this->weaponStats[weaponCritStrength]*100);
        al_draw_textf(smallFont, rarityColor, mouseX, mouseY-120, 0, "Armor Penetration: %.2f%%", this->weaponStats[weaponArmorPenetration]*100);

        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-210, ALLEGRO_ALIGN_RIGHT, "Min: %+.2f%% Max: %+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponMinDamage)*lootSystem.getGunSuffix(this->weaponSuffix, weaponMinDamage)-1)*100, (lootSystem.getGunPrefix(this->weaponPrefix, weaponMaxDamage)*lootSystem.getGunSuffix(this->weaponSuffix, weaponMaxDamage)-1)*100);
        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-195, ALLEGRO_ALIGN_RIGHT, "%+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponFireRate)*lootSystem.getGunSuffix(this->weaponSuffix, weaponFireRate)-1)*100);
        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-180, ALLEGRO_ALIGN_RIGHT, "%+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponShotSpeed)*lootSystem.getGunSuffix(this->weaponSuffix, weaponShotSpeed)-1)*100);
        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-165, ALLEGRO_ALIGN_RIGHT, "%+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponAccuracy)*lootSystem.getGunSuffix(this->weaponSuffix, weaponAccuracy)-1)*100);
        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-150, ALLEGRO_ALIGN_RIGHT, "%+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponCritChance)*lootSystem.getGunSuffix(this->weaponSuffix, weaponCritChance)-1)*100);
        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-135, ALLEGRO_ALIGN_RIGHT, "%+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponCritStrength)*lootSystem.getGunSuffix(this->weaponSuffix, weaponCritStrength)-1)*100);
        al_draw_textf(smallFont, rarityColor, mouseX+550, mouseY-120, ALLEGRO_ALIGN_RIGHT, "%+.2f%%", (lootSystem.getGunPrefix(this->weaponPrefix, weaponArmorPenetration)*lootSystem.getGunSuffix(this->weaponSuffix, weaponArmorPenetration)-1)*100);
